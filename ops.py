...
def load_checkpoint(setup, models_bag, weights_file):
    ...
    if setup["object_color"] == "custom":
        models_bag["color"].load_state_dict(checkpoint['color'])
        # models_bag["color_optimizer"].load_state_dict(checkpoint['color_optimizer'])


def load_checkpoint_all(setup, models_bag, weights_file):
...
def load_checkpoint_raw(setup, models_bag, weights_file):
